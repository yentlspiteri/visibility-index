 ...
 * [action].js → notify), weekly digest (api/cron/[task].js → weeklyDigest).
 *
 ...
 */
export function renderBrandedEmail({ title, heroHeadline, heroEyebrow, bodyHtml, cta, bodyFootnote }) {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="margin:0;padding:0;background:#0B0359;font-family:Helvetica,Arial,sans-serif;color:#0c0b09;line-height:1.55;-webkit-font-smoothing:antialiased;">
  <div style="max-width:600px;margin:0 auto;padding:32px 16px;">
    ...
    <div style="background:linear-gradient(160deg,#3F36B2 0%,#5A50CC 60%,#8683E5 100%);border-radius:24px 24px 0 0;padding:40px 36px 36px;text-align:center;color:#fafafa;">
      ...
      <p style="font-size:28px;line-height:1.2;font-weight:700;letter-spacing:-0.02em;margin:0;color:#fafafa;">
        ${heroHeadline}
      </p>
    </div>
