...
export async function buildReportPDF(rawReport) {
  ...
  const ctx = { pdf, helv, helvBold, helvObl, helvBlack, logoImg };
...
function drawSixSignals(ctx, r) {
  ...
  DIMENSIONS.forEach((d, i) => {
    ...
    drawText(page, commentary[d.key] || d.plain, {
