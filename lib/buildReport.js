...
function drawSixSignals(ctx, r) {
  ...
  DIMENSIONS.forEach((d, i) => {
    ...
    drawText(page, (L.dimLabels[d.key] || d.key).toLowerCase(), {
...
function drawSectionEyebrow(ctx, page, label, y) {
  ...
  const labelW  = safeWidth(ctx.helvBold, lcLabel, 10);
