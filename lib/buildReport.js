...
function drawThreeMoves(ctx, r) {
  ...
  // Minimal card: number + title + 1-line why + DO THIS step + clickable chip.
...
function drawTrendsAndTactics(ctx, r) {
  ...
  TRENDS.forEach((t, i) => {
    ...
    // Body — clamped to 1 line so the card breathes
